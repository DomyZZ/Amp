{block name="page_content"}
    ...
    <ul class="nav nav-tabs">
        <li {($dep_status == "active")?'class="active"':""}>
            <a href="{$admin_url}/deposits" class="text-success">{$lang.label.active}</a>
        </li>
        <li {($dep_status == "expired")?'class="active"':""}>
            <a href="{$admin_url}/deposits/expired" class="text-danger">{$lang.label.expired}</a>
        </li>
    </ul>
    <!-- Tab panels -->
                            ...
                            <div class="form-group">
                                ...
                                <select name="package_id" id="package_id" class="form-control input-sm"
                                    ...
                                    {foreach $packages as $value}
                                        <option value="{$value.id}" {($dt.filter.type==$value.id)?'selected':''}>{$value.name}</option>
                                    {/foreach}
                                </select>
                            </div>
                            <div class="form-group">

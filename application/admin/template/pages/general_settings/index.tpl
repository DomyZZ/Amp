        ...
        <div class="tab-content" id="dq-tab-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="allow_itransfers"
                                       class="control-label col-md-4">{$lang.label.allow_itrans}</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label for="deduct_fee_from"
                                       class="control-label col-md-4">{$lang.label.deduct_fees_from}</label>
                                <div class="col-md-8">
            ...
            <div class="tab-pane fade" id="cron">
                <div class="panel-body">
                    ...
                    <h4>{$lang.label.cron_status}: {($settings.cron.status==1)?'<span class="label label-success">Active</span>':'<span class="label label-danger">Inactive</span>'}</h4>
                    <p>{$lang.label.cron_last_run}: {if $settings.cron.last_ts} {$settings.cron.last_ts|dtformat:'jS M, Y H:i:s'} ({$settings.cron.last_ts|dtformat:'timeago'}){else}Never{/if}</p>
                    <hr />
                    <h5>Cron Command </h5>
                    <h5><code>*/5 * * * * curl -k --silent --compressed {$base_url}/cron/{$settings.cron_hash}</code></h5>

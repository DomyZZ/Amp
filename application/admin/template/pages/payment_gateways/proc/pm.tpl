...
{if $type=='api'}
    ...
    <div class="form-group">
        <label for="pm_api_api_req_ip" class="control-label">{$lang.label.api_req_ip}</label>
        <input type="text" class="form-control input-sm"
               name="payment_details[api][api_req_ip]"
               id="pm_api_api_req_ip"
               value="{$proc.payment_details.api.api_req_ip}" placeholder="e.g. 12.33.11.255"/>
        <small class="help-block text-muted">
            Leave blank to use default server requesting ip.
        </small>
    </div>
    <!-- Modal Help -->

{if $type=='sci'}
    <div class="form-group">
        <label for="sci_doge_payment_system" class="control-label">{$lang.label.payment_system}</label>
            <select name="payment_details[payment_system]" id="sci_doge_payment_system" class="form-control input-sm" onchange="show_ps_details('sci', 'doge')">
...
{if $type=='api'}
    <div class="form-group">
        <label for="api_doge_payment_system" class="control-label">{$lang.label.payment_system}</label>
            <select name="payment_details[api][payment_system]" id="api_doge_payment_system" class="form-control input-sm" onchange="show_ps_details('api', 'doge')">
